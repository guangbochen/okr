module github.com/oneblock-ai/okr

go 1.21

replace (
	github.com/rancher/system-agent => github.com/oneblock-ai/system-agent v0.0.0-20231227120438-31c5db8f4749
	k8s.io/api-machinery => k8s.io/api-machinery v0.28.4
...
require (
	...
	github.com/rancher/system-agent v0.3.4
